...
Kunden verwenden eine eigene Chatseite, Mitarbeiter eine Gesprächsübersicht mit Antworten und Abschließen. Pro Kunde und Mandant gibt es zunächst ein offenes Gespräch; Erstellen und Senden werden durch Datenbanksperren serialisiert. Abgeschlossene Gespräche bleiben lesbar. Eine versionierte Zustimmung mit Zeitpunkt wird bei der ersten Nachricht gespeichert. Der aktuelle Datenschutztext ist ausdrücklich ein Testphasenentwurf; echte Gesundheitsdaten dürfen vor Klärung von Rechtsgrundlage, Aufbewahrung, Widerruf und Löschverfahren nicht verwendet werden.
...
Reservierte Termine werden am Vortag vom täglich geplanten Befehl `app:appointments:send-reminders` erinnert. Jede E-Mail- und Push-Erinnerung wird getrennt am Termin als verarbeitet gespeichert, damit auch bei wiederholter Ausführung keine Doppelzustellung entsteht. Die E-Mail ist eine transaktionale Terminbenachrichtigung und wird unabhängig vom Newsletter versendet. Push bleibt vom Kunden im Profil steuerbar, benötigt eine registrierte Browser-/Gerätefreigabe und enthält nur Uhrzeit sowie den allgemeinen Hinweis auf einen Termin in der Apotheke. Nach erfolgreicher Terminbuchung führt die Kunden-App direkt zur Übersicht „Meine Termine“.
