...
Kunden können pro Mandant im Profil festlegen, welche optionalen Schnellzugriffe im Footer angezeigt werden: Home, Chat, Prämien und – sofern eingerichtet – die Webseite. Die Auswahl beeinflusst ausschließlich die untere Schnellnavigation; alle Bereiche bleiben über das Hauptmenü erreichbar. Der Rechnungsscanner belegt unabhängig von diesen Einstellungen stets die mittlere Footer-Position.
