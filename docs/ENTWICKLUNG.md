...
Die Kundenübersicht ist vom Mitarbeiterbereich getrennt und zunächst bewusst lesend: Sie zeigt ausschließlich Kundenmitgliedschaften des aktuellen Mandanten, ist nach Name, E-Mail-Adresse oder ID durchsuchbar und führt über ein Detailmodal zu den bereits vorhandenen Kontaktdaten. Der Punktestand wird serverseitig aus dem Transaktionsbuch berechnet. Mitarbeiterrollen und Zugangsdaten sind dort nicht sichtbar oder bearbeitbar.
