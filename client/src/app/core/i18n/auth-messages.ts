export const authMessages = {
  registrationConflict: () => $localize`:@@auth.error.registration-conflict:Für diese E-Mail-Adresse besteht bereits ein Konto.`,
  ...
  verificationResendFailed: () => $localize`:@@auth.error.email-verification-resend:Die Bestätigungs-E-Mail konnte gerade nicht angefordert werden. Bitte versuchen Sie es später erneut.`,
