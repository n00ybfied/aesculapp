...
final class ApiAppointmentController{
 ...
 public function cancel(int $id):JsonResponse
 {
  ...
  return $this->em->wrapInTransaction(function()use($appointment):JsonResponse{
   ...
   if($appointment->getStartsAt()<new \DateTimeImmutable('+'.$this->tenant->get()->getAppointmentCancellationHours().' hours'))return new JsonResponse(['message'=>'Bitte kontaktieren Sie die Apotheke zur Stornierung.'],422);
   $appointment->cancel();
