...
export interface TenantBranding { readonly logoUrl: string | null; readonly squareLogoUrl: string | null; readonly faviconUrl: string | null; readonly initialPoints: number; readonly birthdayBonusPoints: number; readonly pointsPerEuro: number; readonly allowDuplicateReceiptImports: boolean; readonly showCustomerDebugOutput: boolean; readonly familyPointSharingEnabled: boolean; readonly familyPointSharingLocked: boolean; readonly receiptQrPrefix: string | null; readonly websiteUrl: string | null; readonly smtpHost: string | null; readonly smtpPort: number | null; readonly smtpEncryption: 'tls' | 'ssl' | 'none' | null; readonly smtpUsername: string | null; readonly smtpFrom: string | null; readonly smtpPasswordConfigured: boolean; }
