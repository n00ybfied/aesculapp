...
@Component({
 ...
 <header><div><p class="eyebrow">KUNDENSERVICE</p><h1>Anfragen</h1></div><button type="button" [disabled]="busy()" (click)="overview()">Gesprächsübersicht</button></header>
