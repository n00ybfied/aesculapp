...
export class TenantBrandingComponent {
  ...
  protected async save(): Promise<void> {
    ...
    try { this.apply(await this.brandingService.update(data)); this.files = {}; this.isPointsPerEuroEditingEnabled.set(false); } catch { this.error.set('Die Marken-Assets konnten nicht gespeichert werden.'); } finally { this.isSaving.set(false); }
  }
